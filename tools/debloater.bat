...
%PSH% "Get-AppxPackage *linkedin* | Remove-AppxPackage"
%PSH% "Get-AppxPackage *hulu* | Remove-AppxPackage"
%PSH% "Get-AppxPackage *netflix* | Remove-AppxPackage"
%PSH% "Get-AppxPackage *sway* | Remove-AppxPackage"
%PSH% "Get-AppxPackage *adobe* | Remove-AppxPackage"
%PSH% "Get-AppxPackage *twitter* | Remove-AppxPackage"
%PSH% "Get-AppxPackage *facebook* | Remove-AppxPackage"
%PSH% "Get-AppxPackage *instagram* | Remove-AppxPackage"
%PSH% "Get-AppxPackage *tiktok* | Remove-AppxPackage"
%PSH% "Get-AppxPackage *hotspotshield* | Remove-AppxPackage"
